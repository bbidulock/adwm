...
XImage *dn_scale_image(AScreen *ds, XImage *ximage, unsigned nw, unsigned nh, Bool bitmap);
XImage *up_scale_image(AScreen *ds, XImage *ximage, unsigned nw, unsigned nh, Bool bitmap);
