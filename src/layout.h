...
void setnmaster(View *v, unsigned n);
void decnmaster(View *v, unsigned n);
void incnmaster(View *v, unsigned n);
void setncolumns(View *v, unsigned n);
void decncolumns(View *v, unsigned n);
void incncolumns(View *v, unsigned n);
